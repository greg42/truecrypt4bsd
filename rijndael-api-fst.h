...
#define     RIJNDAEL_MODE_ECB              1 /*  Are we ciphering in ECB mode?   */
#define     RIJNDAEL_MODE_CBC              2 /*  Are we ciphering in CBC mode?   */
#define     RIJNDAEL_MODE_CFB1             3 /*  Are we ciphering in 1-bit CFB mode? */
...
int rijndael_makeKey(rijndaelKeyInstance *, u_int8_t, int, char *);

int rijndael_cipherInit(rijndaelCipherInstance *, u_int8_t, char *);

int rijndael_blockEncrypt(rijndaelCipherInstance *, rijndaelKeyInstance *, u_int8_t *, int,
	u_int8_t *);
int rijndael_padEncrypt(rijndaelCipherInstance *, rijndaelKeyInstance *, u_int8_t *, int,
	u_int8_t *);

int rijndael_blockDecrypt(rijndaelCipherInstance *, rijndaelKeyInstance *, u_int8_t *, int,
	u_int8_t *);
int rijndael_padDecrypt(rijndaelCipherInstance *, rijndaelKeyInstance *, u_int8_t *, int,
	u_int8_t *);
