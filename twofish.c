...
static int
do_twofish_setkey (TWOFISH_context *ctx, const uint8_t *key, const unsigned keylen)
{
    int i, j, k;
...
int
twofish_setkey (TWOFISH_context *ctx, const uint8_t *key, unsigned int keylen)
{
...
int
twofish_encrypt (const TWOFISH_context *ctx, uint8_t *out, const uint8_t *in)
{
...
int
twofish_decrypt (const TWOFISH_context *ctx, uint8_t *out, const uint8_t *in)
{
